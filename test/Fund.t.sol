...
// @note most of these tests have been autogenerated by ChatGPT
// The test suite from the original Casper implementatin should be ported over
// or the test suite rewritten from scratch
